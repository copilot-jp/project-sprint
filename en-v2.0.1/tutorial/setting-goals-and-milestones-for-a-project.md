...
Also, some projects may have multiple milestones that are set in a multi-line fashion (this is called a "track", which is the same as a "track" for the definition of a track [See Tip 1](broken-reference).) In such cases, we need a granularity and abstraction level that allows us to determine the dependencies and influences among milestones.
...
![Relationship between Goals and Milestones](../../en/images/goal-milestone\_eng.png) (cited from [Project Sprint CODE Essentials](broken-reference)）
...
The actual process of changing them is explained [in Reviewing a project's goals and milestones](broken-reference).

**Tips related to this page**

* [Useful ideas for organizing the project timeline (tracks/phases/events)](broken-reference)
* [Using the Milestone Map](broken-reference)
* [What kinds of things are produced in a project (outputs/artifacts)](broken-reference)
