...
2. [Essentials](../v3.1/essentials.md)を読み、核となる行動規範や重要な箇所をつかむ
3. 分からないことがあれば、[Reference](../v3.2/reference.md)を読み、理解を深める
...
2. [Essentials](../v3.1/essentials.md)を読み、核となる行動規範や重要な箇所をつかむ
3. [Reference](../v3.2/reference.md)を読み、背景にある考え方をより深く理解する
