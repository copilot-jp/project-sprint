...
これまでは、プロジェクトとは最終的な成果の達成までの一連の流れを、できるだけ失敗や手戻りが生じないように順を追って推進していくものであると捉えられてきました。しかし、計画を綿密に立ててもその後大幅に修正が必要になったり、プロジェクト全体を同じ粒度で捉えつづけようとすることでメンバーの認知負荷が高くなりすぎたりすることはよくあります。

そのためProject Sprint では、仮説の設定とその仮説に沿った行動を、短いタイムスパンで小さく実験的に繰り返すという進め方を取ります。

個々の実験において、結果が成功か失敗かはさほど重要なことではありません。「確実にうまくいく」ことを目指して行動の速度が鈍ったり保守的になったりするよりは、「失敗することで見えてくるものもある」と捉えて前向きに挑戦し、得られた結果を次のフェーズの改善材料にしていくのです。ひとつひとつの実験のサイズは、プロジェクト全体から相対的に見て、失敗を許容できる規模のものでなくてはなりません。

この進め方により、プロジェクトチームは、創造性豊かに小さな挑戦を重ね、仮説を検証して小さく軌道修正を繰り返すことで複雑な問題を素早く解決して、最終的な成果に向けてプロジェクトを推進していくことができます。
