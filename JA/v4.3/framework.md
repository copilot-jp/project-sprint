...
Project Sprint は、共通の目的をもち相互に信頼しあうことを前提に、個々のメンバーが意思を持ち主体的かつ自発的に行動できることに価値を置くプロジェクトチームのためのフレームワークである。

このフレームワークは、プロジェクトチームが創造性豊かに小さな実験を重ねて細かく進路を調整しつづけることで、変化の激しい環境の中で複雑な問題を素早く解決し、最終的な成果に向けてプロジェクトを進められるようにすることを目指す。

Project Sprint の考え方を取り入れることで、プロジェクトチームはより主体的にプロジェクトを定義し、より多様な観点から判断し、より自発的に行動し、より創造的に成果を生み出すことができるようになる。

## 2. Project Sprint が理想とする状態

Project Sprint は、チームメンバーの分化的かつ統合的な自律的活動により、プロジェクトの目的達成を目指した作成物が出力されつづけている状態が、プロジェクトチームの理想的な状態であるとする。

Project Sprint におけるプロジェクトでは、各メンバーが個別に活動する作成物の出力と、チーム全員で対話する定例会議とが交互に繰り返される。短い一定のタイムスパンで、同一のプロセスでの処理を繰り返すことで、各メンバーが自律的に行動できる環境と習慣をつくる。

プロジェクトの推進は、個々のチームメンバーがプロジェクトの目的にかなうと信じる作成物を出力しつづけることから生まれる。作成物を出力する手が止まることがないよう、また、生み出される作成物がプロジェクトの目的から外れることがないようにするために存在するのが、この作成物の出力と定例会議の繰り返しをはじめとする、Project Sprint の提案するいくつかの仕組みである。
...
プロジェクトは、各メンバーの個別の活動としての作成物の産出（**出力**）と、チーム全員での活動としての定例会議（**対話**）の、短期的・定期的な反復によって推進される。

このサイクルを維持する要となるのは、**チームメンバーがタスクを実践して作成物を産出する**ことである。プロジェクトの前進につながる作成物の産出自体も重要ではあるが、より重要なのは、各メンバーがタスクの実践を通してプロジェクトや環境の情報、多様な視点からのひらめきや違和感を得て（**一次情報の獲得**）、それらをチームに共有することである。

* **各メンバーの活動（出力）** :&#x20;
  1. 各メンバーが、納得をもって自律的に行動を起こす
  2. 身体的な行動で具体的な作成物を生み出し、その過程で多様な気づきを得る
  3. 作成物自体やその出力に伴って得られた一次情報を材料に、次の対話に向けて準備をする
* **チームでの活動（対話）** :&#x20;
  1. 各メンバーが自身の活動の状況をチームに共有し、タスクの実践を通して産出された作成物と獲得された一次情報を**個人のものからチームのものにする**
...
個人での作成物の産出とチームでの対話というサイクルを短い一定のタイムスパンで繰り返すことにより、各メンバーの具体的な活動に伴って得られた一次情報をもとに対話してチームでの共通了解を形成し、各メンバーが自ら納得した上で次の行動を取ることができる。

出力と対話のサイクルを反復することは、プロジェクトの最終的なゴールを達成するために解決すべき問題を徐々に見極めていく、探索的な実験の繰り返しであると言える。変化しつづける環境に能動的に適応していくために、短い一定のタイムスパンで同一の処理を繰り返し、自律的に行動できる環境を整えるとともに行動を習慣化していく。
...
対話は、個人の活動の範囲内では個人のものでしかなかった作成物を、チームに共有してプロジェクトのものにするプロセスでもある。個人の出力による作成物は、プロジェクトのものになることによって成果や価値につながっていく。
...
これまで述べたように、プロジェクトは、出力と対話の短期的・定期的・反復的なサイクルによって推進される。このサイクルを維持し改善しつづけるために必要な3つの仕組みについて、順に記述する。

#### ① 定例会議でパターンとリズムをつくる

Project Sprint における対話の場となるのが**定例会議**である。定例会議とは、チームが短期的・定期的なサイクルで反復的に実施する会議のことである。
