...
* **フラッグ**　チームが、外部からの制約や実現したい価値・成果を踏まえ、ある目的をもって設定したゴール。
* **ゴール**　チームがある期日において達成していたい状態。要素として、あるべき状態・成果物・完了日の3つをもつ。プロジェクト自体の到達点を最終ゴールと呼び、プロジェクト内におおまかに置かれた中間到達点を中間ゴールと呼ぶ。
