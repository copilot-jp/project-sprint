...
* **成果**　プロジェクトチームやチームが、プロジェクトにおいて実現を目指す価値を踏まえ、プロジェクト内の他チームやプロジェクト全体に向けて生み出す所産。
* **フェーズ**　プロジェクトチームやチームが、ある目的をもって活動する期間。
* **プロジェクトストーリー**　プロジェクトチームが次の行動を決定するための指針として、最終ゴール達成までの過程をシンプルに時系列で表現したもの。各チームのフラッグが集まることで表現される。
* **フラッグ**　プロジェクトチームやチームが、外部からの制約や実現したい価値・成果を踏まえ、ある目的をもって設定したゴールとその達成までの過程。
* **ゴール**　プロジェクトチームやチームが、ある期日において達成していたい状態。要素として、あるべき姿・成果物・完了日の3つをもつ。プロジェクト自体の到達点を最終ゴールと呼び、プロジェクト内におおまかに置かれた中間到達点を中間ゴールと呼ぶ。
