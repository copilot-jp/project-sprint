...
以下の表は、それぞれの側面における認識のしかたを整理したものである。なお、このフレームワークではここまで主にプログレス的側面を取り上げてきた。チーミング的側面及びプロセス的側面については、それぞれこの後のセクションで取り上げる。

|    |  プログレス  |  チーミング  |  プロセス  |
| ---- | ---- | ---- | ---- |
|  何に焦点を当てるか  |  成果  |  チームメンバー相互の関係  |  プロジェクトを最適化する仕組み  |
|  何を目指すか  |  成果の実現  |  理想的なプロジェクトチームの形成  |  プロジェクトの最適化  |
|  どのような観点から<BR>プロジェクトを捉えるか  |  最終的な成果を達成するまでの行程を<BR>小さな成果の積み重ねに細分化して漸進的に達成する  |  メンバー相互の信頼関係の構築と<BR>各メンバーの自律的・主体的な思考・行動の実現  |  個々の実験からのフィードバックを活用して<BR>成果の仮説やプロジェクトチームの状態を最適化する  |
|  重視される実践  |  成果の仮説の設定と更新<BR>成果の進捗・達成  |  価値や成果への認識共有と納得<BR>各自の責任や役割の自覚と引き受けによる<BR>メンバー相互の期待値の共有  |  出力を通した作成物やアイデア・違和感の獲得<BR>それらをアジェンダとして持ち寄る定例会議  |
|  実践の意義  |  外部への価値提供を見据えたプロジェクトの推進  |  プロジェクトのプログレス的側面の円滑な推進  |  プロジェクトのプログレス的側面・チーミング的側面の円滑な推進  |
|  重視される価値観  |  **反復的・漸進的**な成果の実現<BR>**環境の変化に即応**した成果の仮説更新  |  相互の信頼に基づく各自の**行動の自己決定**<BR>認識共有によるチームの**一貫性**維持<BR>**チーム全員でのプロジェクト推進**  |  **定期的・反復的**な同期<BR>**継続的・漸進的**な改善<BR>アイデアの**共同創造**・問題の**共同解決**  |
