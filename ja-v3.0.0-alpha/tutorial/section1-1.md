...
プロジェクトスプリントの基本のメカニズムは、「個人単位で作成物の出力に取り組み、その成果を定期的・反復的なミーティングで共有し認識を合わせることによって、プロジェクトの進め方を継続的に改善し、各メンバーが自律的に次の行動に向かえるようにする。その繰り返しがプロジェクトを現在の状態から理想の状態に漸進的に近づけ、結果としてプロジェクトゴールが達成される。」というものです。
...
- プロジェクトチームは、作成物を生み出すことにより、自ら設定したプロジェクトゴールに向かい漸進的に進む。
  - その結果、各メンバーが作成物の出力に取り組む中で、他のメンバーに伝えたいひらめきや違和感が生まれる。
- プロジェクトチームは、各メンバーが生み出したひらめきや違和感を、アイデアやテンションとして共有する。
  - そのために、アイデアやテンションをミーティングのアジェンダとして提出し、アイデアを共同創造したり問題の共同解決を行ったりする。
