...
![予測型で進むプロジェクト](images/illust_prediction.png "予測型で進むプロジェクト")
...
![適応型で進むプロジェクト](images/illust_daptation.png "適応型で進むプロジェクト")
...
![変化への能動性のグラデーション](images/illust_gradation.png "変化への能動性のグラデーション")
