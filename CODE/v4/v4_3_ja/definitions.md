...
![予測型で進むプロジェクト](images/illust\_prediction.png "予測型で進むプロジェクト")
...
![適応型で進むプロジェクト](images/illust\_daptation.png "適応型で進むプロジェクト")
...
![変化への能動性のグラデーション](images/illust\_gradation.png "変化への能動性のグラデーション")
