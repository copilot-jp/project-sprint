...
個人の活動とチームとしての活動をつなぎ、双方の実行と最適化を促進するための仕組みが推進プロセスであり、その軸となるのは、チームでのミーティングとそこでのアジェンダの議論です。個々人がタスクに取り組む中で生まれた作成物やアイデア・問題・テンションをミーティングで共有し認識を揃えることによって、プロジェクトチームとしてのアイデアを共同創造し、問題の共同解決を行って次の行動を決定することが重要です。
...
![定期的な振り返りの必要性](/ja/images/process.png)
（PMBOKの概念を参照）
...
###### プロジェクトとルーチンワークの違い
![プロジェクトとルーチンワークの違い](/ja/images/project.png)
