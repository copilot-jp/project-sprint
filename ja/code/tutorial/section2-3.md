...
#### ミーティングの設計
プロジェクトスプリントでは「チームメンバー全員が空間や時間を共有し、素早く効率的な認識合わせと、全員が納得した意思決定をする場」ための場として「ミーティング」を位置づけています。これは、会話することがこの目的を達成するために最も適していると考えられるからです。したがってミーティングもこの目的のために適切にデザインし、プロジェクトメンバーで合意しましょう。
