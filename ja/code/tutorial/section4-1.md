...
プロジェクトスプリントでは、ミーティングを通じて継続的にプロジェクトの進め方を改善すること（最適化）を目指しています。これらの最適化のため取り組みを総称して「[継続的改善アプローチ](../tips/tips4.md)」と呼んでおり、これはさらに「テンショントリアージ」と「振り返り」という二つの取り組みに分けられます。
...
##### このページと関係するTips
- [継続的改善アプローチ](../tips/tips4.md)
- [代表的な振り返りの手法](../tips/tips5.md)
- [テンショントリアージの方法](../tips/tips6.md)
---
