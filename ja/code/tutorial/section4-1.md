...
「[プロジェクトスプリントの原理](../essentials.md)」でも記載しているようにプロジェクトスプリントでは、単にプロジェクトの進捗だけでなく、個人の活動やチームとしての活動が理想の状態にあるかどうか、また推進プロセスが円滑に機能しているかどうかがプロジェクトを進めていく上で重要な要素と考えており、継続的改善アプローチでも、これらを検証することを推奨しています。
