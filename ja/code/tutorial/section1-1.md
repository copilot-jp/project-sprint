...
3. **推進プロセス**：個人の活動、チームとしての活動双方の実行と最適化を促進するための仕組みです。**ミーティング**で、タスクの実行結果や問題点、テンションを**アジェンダ**として持ち寄り、情報共有や問題発見・解決、意思決定などを行えるようにすることが重要です。ミーティングのアウトプットとして次のタスクが生まれ、次のミーティングでのアジェンダの材料となっていきます。チームはこうして継続的な改善を行いながら、プロジェクトゴールの達成に近づいていきます。
推進プロセスは、全メンバーが同期する定期的・反復的なミーティングだけでなく、一部のメンバーで行われる会議や必要性に応じてスポットで行われる会議でも有効に機能します。
