...
作成物  |・顧客定義シート  ・顧客リスト   |・UXマップ   ・サービス機能リスト   ・顧客ヒアリング（5人分）    |・クラウドファンディング実験結果まとめ   ・ユーザーアンケート   
あるべき姿  |・顧客に今回の問題があることをメンバーが確信できている  ・どこに顧客が存在するのかわかっている  |・必要な最小限の機能が把握できている | ・次のステップとしてリリースできる機能の範囲が決まっている  
メモ  |    |    |   
