...
### マイルストーンの見直しをするべきタイミング

マイルストーンの見直しのタイミングは、次のようなときである。この見直しには、マイルストーン全体の大きな方針変更や、プロジェクトの進行に即した細かな調整のいずれも含む。
...
また、マイルストーンがいつまでも詳細なものにならない、達成できないという状況に備え、定期的なタイミングで強制的にマイルストーンの見直しを行ない、必要に応じて調整する機会を設けることも同時に必要である。
