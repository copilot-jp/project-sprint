...
#### ミーティングの参加者に求められる態度
会議の目的は、適切な意思決定を行うことである。

そのためには、意思決定する対象の状況をまず適切に捉える必要があるが、状況が意味するものは往々にして多義的で、複数の解釈が存在しうるものである。状況判断を誤ると適切に意思決定を行うことはできないため、まずは多様な解釈を共有して、状況の多様性・複雑性をそのまま把握することが適切な意思決定を行う土台となる。

会議では、まず、お互いの考えの一致点・相違点を認識しながら、状況に対してチームとしての共通認識を作ることが重要である。

そこで大事なのは、「意思決定」の前に、「そもそも問うべきもの・検討すべきものは何なのか？」ということについての共通認識を作ることである。なぜなら、問うべきもの・検討すべきものがそもそもズレていたとするならば、いくら検討しても正しい意思決定にはならないためである。

状況をありのままに理解した上で、「問うべきもの」「検討すべきもの」についての共通認識をチームとして作り、適切な意思決定につなげていくことが不可欠である。このとき、共通認識をつくるための出発点となるのがプロジェクトのゴールやマイルストーン、チームメンバーのロールである。

そのような会議を実現するために、参加者には以下のような態度が求めらる。

* 絶対的な正解が存在するとは限らないことを受け入れること
* 誰かが正解を教えてくれるはずという他者への依存的態度ではなく、チームとしての解釈を一つずつ積み上げていこうというマインドで参加すること
* そのため、まずは各自が考えていること・感じていることを率直に提示すること
* また、他者の考えに対する価値判断を保留し、「そのような考え方もあるのだな」と受け入れること
