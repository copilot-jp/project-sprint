...
チームメンバーは、ミーティングの場で全員でアジェンダを議論する。これによって、個々人中にとどまっている情報を一斉に共有することができ、各メンバーはこのプロセスに参加するだけでプロジェクトの状況や個々人の思っていることについて自然と認識を合わせることができる。すなわち、チームメンバーの**素早く効率的な認識合わせ**と**納得を伴う意思決定**を実現できるのである。
...
また、マイルストーンはチームメンバー全員が納得の上で作られる必要がある。これは、チームがするべきこと、目指すべきことの見通しをできるだけ一致させ、それぞれのメンバーが自発的に自分のつくるべきアウトプットを考えることを可能にするためである。

そのため、マイルストーンは全員に明文化されたかたちで共有され、つねに参照可能でなければならない。
