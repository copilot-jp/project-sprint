...
スーパーグッドプロセスは、個々人のアクティビティをプロジェクト全体の成果に反映させるためのプロジェクトスプリント特有の仕組みであり、次のような仕組みを通じて、他のプロジェクトスプリント上の活動と接続している。
...
### スーパーグッドプロセスの予約ロール
スーパーグッドプロセスの予約ロールは **プロセスアドミン** である。プロセスアドミンは、スーパーグッドプロセスの実践と最適化をリードする。
...
- As-IsやTo-Beに関して、実際にデリバラブル・アクティビティを行っていかなければ明らかにならないこと (**解像度の問題**)

プロジェクトスプリントは、スーパーグッドプロセスとマイルストーンの設定によってこれらの問題を解決する。
...
#### マイルストーンの性質
マイルストーンは、チームによって任意に変更されうる。これは、実際にデリバラブル・アクティビティをこなす中でAs-IsとTo-Beが変化し、プロジェクトのゴールのために必要なことや、場合によってはプロジェクトのゴールそのものを見直すことがあるからである。

### プログレスの予約ロール
プログレスの予約ロールは **プログレスマネジメント** である。プログレスマネジメントは、デリバラブル・アクティビティの実践と最適化、およびこれによってもたらされるプロジェクトのゴールの達成をリードする。
...
### チーミングにおける予約ロール
チーミングの予約ロールは **チームマネジメント** である。チームマネジメントは、メンタル・アクティビティの実践と最適化、およびこれによってもたらされる自律的で理想的なチームの形成をリードする。
