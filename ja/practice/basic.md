...
#### 複数回以上のミーティングを横断する仕組み:振り返り（プロセス）
...
プロセスにおける振り返りの目的は、最適化である。振り返りによって、プロジェクトスプリントの3つのドメイン（プログレス、チーミング、プロセス）における最適化のためのToDoが生まれる。
...
### 振り返り(チーミング）
チーミングにも振り返りが存在する。ここでの振り返りの目的は、チームメンバーが互いのロールを明示的に確認し、期待値が合致していることを確認することである。

<!-- 内容 理論編ベーシックで書かれている"振り返り"に相当するもの-->
