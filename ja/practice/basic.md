# プロジェクトスプリント CODE 実践編 ベーシック

このドキュメントは、プロジェクトスプリントの基本的な実践方法を説明している。[CODE 理論編ベーシック](/ja/practice/basic.md)と合わせて、プロジェクトスプリントに必須の内容を説明しており、これら二つのドキュメントは総称して「プロジェクトスプリント エッセンシャルズ」と呼ばれる。
