...
##### 振り返りの種類
振り返りは、目的によって二つに分けられる。
- 最適化のための振り返り：プロジェクトスプリントの3つのドメイン（プログレス、チーミング、プロセス）における最適化のためのToDoを生むための作業。

<!--Todo/タスクといった内容の整理は別issue or branchで対応-->

- チーミングのステータス確認のための振り返り：チームメンバーが互いのロールを明示的に確認し、期待値が合致していることを確認する作業

<!-- 二つ目が、内容 理論編ベーシックで書かれている"振り返り"に相当するもの-->
