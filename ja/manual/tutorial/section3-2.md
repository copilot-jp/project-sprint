...
なお、タスク確認とテンショントリアージはそれ自体がアジェンダです。したがって、後述するアジェンダトリアージの前に実施されるものではありますが、ファシリテーター（モデレーター）がこれらのアジェンダの進行についても管理する必要があります。
...
1. ミーティング前に提出のあったアジェンダ
1. タスク確認またはテンショントリアージの結果、新たに生まれたアジェンダ
1. 前週までの持ち越しアジェンダ
