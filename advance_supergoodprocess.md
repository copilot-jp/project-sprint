# プロジェクトスプリント アドバンス[スーパーグッドプロセス編]

このドキュメントは、[プロジェクトスプリント エッセンシャルズ](https://copilot-jp.github.io/project-sprint/essentials.html) に記載されている内容のうち、特にスーパーグッドプロセスに関連して、メソッドをより完全なかたちで導入するために推奨される概念やフレームワークについて説明する。
...
##### 議論を促す人
プロジェクトスプリントにおける会議が適切に機能するために、予め会議を運営するためのロールを設定する(**ミーティングロール** の設定）
...
また、ミーティングはある一定の期間による開催(**定例会議**)とすることが不可欠である。これは、不確実性の高い状況下ではプロジェクトの進捗やゴールの妥当性・チームの状況の定点観測が欠かせないことから求められる。
