...
では、「過去」「現在」「未来」について、具体的に何を見るとよいでしょうか。 [Project Sprint 101](101.md)でも記載しているように、Project Sprintでは単にプロジェクトの進捗を見るのではなく、プログレスやチーミングが理想の状態にあるかどうか、またプロセスが円滑に機能しているかどうかがプロジェクトを進めていく上で重要な要素と考えており、継続的改善アプローチでも、これらを検証することを推奨しています。
