...
* [CODE (Japanese)](ja/README.md)
  * [Tutorial](ja/tutorial/README.md)
    1. はじめに
     1. [Project Sprint 101](ja/tutorial/section1-1.md)
    1. 準備しよう
     1. [プロジェクトの環境整備](ja/tutorial/section2-0.md)
     1. [プロジェクトゴールとマイルストーンを設定する](ja/tutorial/section2-1.md)
      1. [プロジェクトゴールやマイルストーンの設定が難しいときの始め方](ja/tutorial/section2-1-1.md)
　    1. [プロジェクトの時間軸を整理するための便利な考え方（トラック/フェーズ)](ja/tutorial/section2-1-2.md)
     1. [チームメンバーを知り、ロールを設定する](ja/tutorial/section2-2.md)
     1. [ミーティングを設計する](ja/tutorial/section2-3.md)
    1. やってみよう
     1. [ミーティングの準備をする](ja/tutorial/section3-1.md)
     1. [ミーティングを開催する](ja/tutorial/section3-2.md)
      1. [タスクを設定する](ja/tutorial/section3-2-1.md)
     1. [ミーティング環境についてのノウハウ](ja/tutorial/section3-3.md)
    1. 改善しよう
     1. [継続的改善アプローチ](ja/tutorial/section4-1.md)
      1. [過去の経験を活かす：振り返り](ja/tutorial/section4-1-1.md)
      1. [現在の心の声を活用する：テンショントリアージ](ja/tutorial/section4-1-2.md)
     1. [未来の展望と仮説：ロールセッション](ja/tutorial/section4-1-3.md)
    1. [プロジェクトゴールとマイルストーンを見直す](ja/tutorial/section4-2.md)
    1. [ロールを確認する](ja/tutorial/section4-3.md)
    1. [プロジェクトスプリントの成功指標](ja/tutorial/section4-4.md)
