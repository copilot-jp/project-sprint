...
Tension triage is an approach that is conducted at each meeting, as described in the section [on Holding a meeting](broken-reference), and mainly focuses on the current feelings of team members.
...
* [Typical Reflection Techniques (tip9)](broken-reference)
* [Setting up roles that are easy to use in practice (tip5)](broken-reference)
