...
[ミーティングを設計する](https://github.com/copilot-jp/project-sprint/blob/Gitbook-v2.2.0/ja/code/tutorial/section2-3/README.md)で記述したように、プロジェクトスプリントではミーティングを定期開催とすることが必要です。ここでは、その理由について解説します。
...
![定期的な振り返りの必要性](../../ja/images/process.png) （PMBOKの概念を参照）
